...
{
    public partial class hackerdata : System.Web.UI.Page
    {
        ...
        private void loaddata()
        {
            ...
            cmd.Connection = con;
            cmd.CommandText = "select * from hacker order by id desc";
            con.Open();
        ...
        private void loaddata2()
        {
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["conStr"].ConnectionString);
            cmd.Connection = con;
            cmd.CommandText = "select * from WalletTransactions order by transactionid desc";
            con.Open();

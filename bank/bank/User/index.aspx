<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="bank.user.index" %>
                                    ...
                                    <div class="panel box-v1">
                                      <div class="panel-heading bg-white border-none">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6 text-right">
                                           <h4>
                                           <span class="icon-Money icons icon text-right"></span>
                                           </h4>
                                        </div>
                                      </div>
                                      <div class="panel-body text-center">
                                        <h1><asp:Label ID="bal" runat="server"></asp:Label></h1>
                                       <%-- <p>User active</p>--%>
                                        <hr/>
                                      </div>
                                    </div>
                              ...
                              <div class="panel box-v2">
                                  <div class="panel-heading padding-0">
                                    ...
                                    <div class="box-v2-detail">
                                      ...
                                      <h4><asp:Label ID="Label3" runat="server" Text="Label"></asp:Label></h4>
                                    </div>
                                  </div>
            ...
            <div id="right-menu">
              ...
              <div class="tab-content">
                ...
                <div class="col-md-12 chatbox">
                  <div class="col-md-12">
                    <a href="#" class="close-chat">X</a><h4>Test<asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></h4>
                  </div>
                  <div class="chat-area">

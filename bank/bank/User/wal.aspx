<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wal.aspx.cs" Inherits="bank.User.wal" %>
...
.flip-card-front {
    font-size: 3rem; /* icon size bigger */
}
    </style>
                ...
                <div class="navbar-header" style="width: 100%;">
                    ...
                    <ul class="nav navbar-nav navbar-right user-nav">
                        <li class="user-name"><span>
                            <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></span></li>
    ...
    <span class="fa-angle-right fa right-arrow text-right"></span>
                            ...
                            <ul class="nav nav-list tree">
                                <li><a href="AddWallet.aspx">Add Money </a></li>
                                                <li><a href="wal.aspx">View Balance</a></li>
                            </ul>
                        </li>
                                ...
                                <div class="col-md-12">
                                    <div class="panel box-v1">
                                        ...
                                        <div class="panel-body text-center">
                                            <h1>
                                                <asp:Label ID="bal" runat="server" ></asp:Label> Rs
</h1>
                                            <%-- <p>User active</p>--%>
                                            <hr />
                                        </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Statement.aspx.cs" Inherits="bank.user.Statement" %>
 ...
 <body id="mimin" class="dashboard">
  ...
  <ul class="nav nav-list tree">
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Statement</h3>
              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>Statement</h3></div>
                    <div class="panel-body">
    ...
    <table id="datatables-example" class="table table-striped table-bordered" width="100%" cellspacing="0">
        ...
        <tbody>
            <asp:Repeater ID="rptUserAccounts" runat="server">
                <ItemTemplate>
                    <tr>
                        <td><%# Eval("Id") %></td>
                        ...
                        <td><%# Eval("Address") %></td>
                        <td><%# Eval("Pincode") %></td>
                        <td><%# Eval("NomineeName") %></td>
                        <td><%# Eval("BankName") %></td>
                        <td><%# Eval("AccountType") %></td>
                        <td><%# Eval("CreatedDate", "{0:yyyy-MM-dd HH:mm:ss}") %></td>
                        <td><%# Eval("skey") %></td>
                        <td><%# Eval("accstatus") %></td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
        </tbody>

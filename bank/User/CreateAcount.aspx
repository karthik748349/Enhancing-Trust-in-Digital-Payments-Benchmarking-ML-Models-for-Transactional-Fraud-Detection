<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateAcount.aspx.cs" Inherits="bank.user.CreateAcount" %>
          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span> <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></span></li>
                  <li class="dropdown avatar-dropdown">
                   <img src="asset/img/avatar.jpg" class="img-circle avatar" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"/>
                   <ul class="dropdown-menu user-dropdown">
                     <li><a href="../logout.aspx"><span class="fa fa-user"></span> Logout</a></li>
              ...
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple">
                     ...
                     <li class="active ripple">
   <a class="tree-toggle nav-header"><span class="fa-home fa"></span> Transaction
     <span class="fa-angle-right fa right-arrow text-right"></span>
   </a>
   <ul class="nav nav-list tree">
       <li><a href="manage.aspx">View Transaction </a></li>
       <li><a href="Trans.aspx">Transfer Money</a></li>
   </ul>
 </li>


                                        <li class="active ripple">
  <a class="tree-toggle nav-header"><span class="fa-home fa"></span> Account
    <span class="fa-angle-right fa right-arrow text-right"></span>
  </a>
  <ul class="nav nav-list tree">
      <li><a href="createAcount.aspx">Create Account </a></li>
      <li><a href="statement.aspx">Manage Account</a></li>
  </ul>
</li>


                                                            <li class="active ripple">
  <a class="tree-toggle nav-header"><span class="fa-home fa"></span> Amount
    <span class="fa-angle-right fa right-arrow text-right"></span>
  </a>
  <ul class="nav nav-list tree">
      <li><a href="AddWallet.aspx">Add Money </a></li>
     <%-- <li><a href="manage.aspx">Manage Account</a></li>--%>
  </ul>
</li>
        ...
        <div id="content">
            <div class="panel box-shadow-none content-header">
                <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">CreateAccount</h3>
            ...
            <div class="form-element">
                            ...
                            <div class="panel-body" style="padding-bottom: 30px;">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" runat="server" id="gen">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label text-right">Emal</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" runat="server" id="phn">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-2 control-label text-right">Aadhar Number</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" runat="server" id="aad">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-2 control-label text-right">Pan Number</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" runat="server" id="pannum">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" runat="server" id="ads">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" runat="server" id="pin">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label text-right">Nominee Name </label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" runat="server" id="nname">
                                        </div>
                                    </div>


                                    <div class="form-group">
                                        <label class="col-sm-2 control-label text-right">Bank </label>
                                        <div class="col-sm-10">
                                            <select class="form-control" id="ddlBank" runat="server">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label text-right">Account Type </label>
                                        <div class="col-sm-10">
                                            <select class="form-control" id="ddlAccountType" runat="server">
             ...
             <div class="col-sm-10">
                 <input type="submit" class="submit btn btn-Success" runat="server" id="Text1"  onserverclick="Text1_ServerClick">
             </div>
         </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Trans.aspx.cs" Inherits="bank.user.Trans" %>
...
<head runat="server">
 ...
 <body id="mimin" class="dashboard">
  ...
  <ul class="nav nav-list tree">
        ...
        <div id="content">
            <div class="panel box-shadow-none content-header">
                <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Send Money</h3>
    ...
    <div class="col-md-12">
        <div class="panel form-element-padding">
            ...
            <div class="panel-body">
                ...
                <asp:DropDownList ID="ddlSenderAccount" runat="server" CssClass="form-control" AppendDataBoundItems="true">
                ...
                <asp:TextBox ID="txtReceiver1" runat="server" CssClass="form-control" placeholder="Enter Receiver Account Number"></asp:TextBox>
            </div>
                     <div class="form-group">
                <label>Re-enter Receiver Account Number:</label>
                <asp:TextBox ID="txtReceiver2" runat="server" CssClass="form-control" placeholder="Re-enter Receiver Account Number"></asp:TextBox>
            </div>
    ...
    <asp:TextBox ID="TextKey" runat="server" CssClass="form-control" placeholder="Enter Key"></asp:TextBox>
</div>
                     <br /> <br />
                    <!-- Submit Button -->
                    <div class="form-group">
                        <div class="col-sm-10 col-sm-offset-2">
                            <asp:Button ID="btnAddWallet" runat="server" CssClass="btn btn-success" Text="Share" OnClick="btnTransfer_Click" />
                        </div>
                    </div>
...
<asp:HiddenField ID="hfIP" runat="server" />
    ...
    fetch('https://api.ipify.org?format=json')
        ...
        .then(data => {
            document.getElementById('<%= hfIP.ClientID %>').value = data.ip;
        });
            </script>
